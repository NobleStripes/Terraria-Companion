...
export function createCommandRegistryCore({
  ...
  const presetCommands: PaletteCommand[] = [
    ...
    {
      id: 'preset-bosses-ready',
      label: 'Preset: Bosses Ready Checklist',
      keywords: 'bosses preset readiness checklist ready prep',
      group: 'Presets',
      priority: 78,
      run: () => navigate('/bosses?prep=ready'),
    },
    {
      id: 'preset-bosses-needs-prep',
      label: 'Preset: Bosses Need Prep',
      keywords: 'bosses preset prep missing readiness',
      group: 'Presets',
      priority: 77,
      run: () => navigate('/bosses?prep=needs'),
    },
    {
      id: 'preset-bosses-wishlist',
      label: 'Preset: Boss Wishlist',
      keywords: 'bosses preset wishlist drops wished farm',
      group: 'Presets',
      priority: 79,
      run: () => navigate('/bosses?drops=wished'),
    },
    {
